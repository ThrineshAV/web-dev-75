    ...
    return(
       <div className="flex justify-center items-center w-screen my-3.5">
        <div className="border p-9 rounded w-3/5 shadow-lg">
            <div className="mb-7">
                <h1 className="font-extrabold text-3xl text-black">Set your new Goal!</h1>
            </div>
            <div className="my-4">
            ...
            <div className="my-4 flex flex-col">
                ...
                }} className="border border-gray-300  focus:ring-0 focus:outline-none focus:border-opacity-50 focus:border-2  placeholder:text-base placeholder:text-slate-400 px-3 py-2 rounded-md " ></input>
            </div>
            <div className="flex flex-col my-4">
                <label htmlFor="i3" className="font-semibold">Description</label>
                <textarea name="" id="i3" placeholder="Enter the description of your goal " className="border rounded h-24 px-3 py-2" value={description} onChange={(e)=>{
